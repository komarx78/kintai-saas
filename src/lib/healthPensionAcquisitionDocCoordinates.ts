...
export const CIRCLE_MARK_COORDINATES: Record<string, CircleOptionMap> = {
  ...
  birthEra_1: {
    '5': { x: 56.8, y: 26.2, w: 22, h: 16 },
    '7': { x: 56.8, y: 27.3, w: 22, h: 16 },
    '9': { x: 56.8, y: 28.4, w: 22, h: 16 }
  },
  // ④ 種別（1:男、2:女、3:坑内員、5:男基金、6:女基金、7:坑内員基金）
  gender_1: {
    '1': { x: 82.5, y: 26.5, w: 22, h: 16 },
    '2': { x: 82.5, y: 27.6, w: 22, h: 16 },
    '3': { x: 82.5, y: 28.7, w: 26, h: 16 },
    '5': { x: 89.5, y: 26.5, w: 28, h: 16 },
    '6': { x: 89.5, y: 27.6, w: 28, h: 16 },
    '7': { x: 89.5, y: 28.7, w: 32, h: 16 }
  },
  // ⑤ 取得区分（1:健保・厚年、3:共済出向、4:船保任継）
  acqCategory_1: {
    '1': { x: 11.8, y: 31.8, w: 30, h: 16 },
    '3': { x: 11.8, y: 32.9, w: 28, h: 16 },
    '4': { x: 11.8, y: 34.0, w: 28, h: 16 }
  },
  // ⑦ 取得年月日 元号（9:令和）
  acqEra_1: {
    '9': { x: 56.8, y: 31.8, w: 22, h: 16 }
  },
  // ⑧ 被扶養者（0:無、1:有）
  dependents_1: {
    '0': { x: 83.0, y: 31.8, w: 22, h: 16 },
    '1': { x: 90.2, y: 31.8, w: 22, h: 16 }
  },
  // ⑩ 備考（1:70歳以上、2:二以上事業所、3:短時間、4:再雇用、5:その他）
  remarks_1: {
    '1': { x: 64.0, y: 35.0, w: 34, h: 16 },
    '2': { x: 64.0, y: 36.2, w: 36, h: 16 },
    '3': { x: 78.0, y: 35.0, w: 40, h: 16 },
    '4': { x: 78.0, y: 36.2, w: 38, h: 16 },
    '5': { x: 78.0, y: 37.2, w: 26, h: 16 }
  }
};
...
export const DEFAULT_HEALTH_PENSION_ACQ_FIELDS: HealthPensionAcqFieldConfig[] = [
  ...
  },
  {
    ...
    width: 15.0,
    example: '250000',
    description: '金銭で支払われる基本給・手当の合計（マス目印字）'
  },
  {
    ...
    width: 15.0,
    example: '',
    description: '食事・住宅等、現物で支給される評価額（マス目印字）'
  },
  {
...
const STORAGE_KEY = 'mock_health_pension_acq_doc_coords_v4_precision';
