...
export const DEFAULT_TAX_FIELDS: TaxDocFieldConfig[] = [
  ...
  { id: 'spouseEraMeiji', name: '配偶者元号 明（○印）', section: 'spouse', x: 38.6, y: 22.8, fontSize: 7, example: '○', description: 'Ａ欄元号 上段左「明」の○印', isCircle: true },
  { id: 'spouseEraTaisho', name: '配偶者元号 大（○印）', section: 'spouse', x: 39.4, y: 22.8, fontSize: 7, example: '○', description: 'Ａ欄元号 上段右「大」の○印', isCircle: true },
  { id: 'spouseEraShowa', name: '配偶者元号 昭（○印）', section: 'spouse', x: 38.6, y: 23.9, fontSize: 7, example: '○', description: 'Ａ欄元号 下段左「昭」の○印', isCircle: true },
  { id: 'spouseEraHeisei', name: '配偶者元号 平（○印）', section: 'spouse', x: 39.4, y: 23.9, fontSize: 7, example: '○', description: 'Ａ欄元号 下段右「平」の○印', isCircle: true },
  { id: 'spouseEraReiwa', name: '配偶者元号 令（○印）', section: 'spouse', x: 40.2, y: 23.9, fontSize: 7, example: '○', description: 'Ａ欄元号 「令」の○印', isCircle: true },
  ...
  { id: 'spouseLiving', name: '生計を一にする事実（別居時）', section: 'spouse', x: 58.5, y: 23.8, fontSize: 9, example: '', description: 'Ａ欄生計一事実（別居時のみ記載）' },
  ...
  { id: 'dep0EraMeiji', name: '扶養1元号 明（○印）', section: 'dependent', x: 38.6, y: 26.5, fontSize: 7, example: '○', description: 'Ｂ欄1人目 上段左「明」○印', isCircle: true },
  { id: 'dep0EraTaisho', name: '扶養1元号 大（○印）', section: 'dependent', x: 39.4, y: 26.5, fontSize: 7, example: '○', description: 'Ｂ欄1人目 上段右「大」○印', isCircle: true },
  { id: 'dep0EraShowa', name: '扶養1元号 昭（○印）', section: 'dependent', x: 38.6, y: 27.6, fontSize: 7, example: '○', description: 'Ｂ欄1人目 下段左「昭」○印', isCircle: true },
  { id: 'dep0EraHeisei', name: '扶養1元号 平（○印）', section: 'dependent', x: 39.4, y: 27.6, fontSize: 7, example: '○', description: 'Ｂ欄1人目 下段右「平」○印', isCircle: true },
  { id: 'dep0EraReiwa', name: '扶養1元号 令（○印）', section: 'dependent', x: 40.2, y: 27.6, fontSize: 7, example: '○', description: 'Ｂ欄1人目 「令」○印', isCircle: true },
  ...
  { id: 'dep0Living', name: '扶養1 同居別居（別居時）', section: 'dependent', x: 58.5, y: 27.5, fontSize: 9, example: '', description: 'Ｂ欄1人目生計一（別居時のみ記載）' },
  ...
  { id: 'dep1EraMeiji', name: '扶養2元号 明（○印）', section: 'dependent', x: 38.6, y: 31.5, fontSize: 7, example: '○', description: 'Ｂ欄2人目 上段左「明」○印', isCircle: true },
  { id: 'dep1EraTaisho', name: '扶養2元号 大（○印）', section: 'dependent', x: 39.4, y: 31.5, fontSize: 7, example: '○', description: 'Ｂ欄2人目 上段右「大」○印', isCircle: true },
  { id: 'dep1EraShowa', name: '扶養2元号 昭（○印）', section: 'dependent', x: 38.6, y: 32.6, fontSize: 7, example: '○', description: 'Ｂ欄2人目 下段左「昭」○印', isCircle: true },
  { id: 'dep1EraHeisei', name: '扶養2元号 平（○印）', section: 'dependent', x: 39.4, y: 32.6, fontSize: 7, example: '○', description: 'Ｂ欄2人目 下段右「平」○印', isCircle: true },
  { id: 'dep1EraReiwa', name: '扶養2元号 令（○印）', section: 'dependent', x: 40.2, y: 32.6, fontSize: 7, example: '○', description: 'Ｂ欄2人目 「令」○印', isCircle: true },
  ...
  { id: 'dep1Living', name: '扶養2 同居別居（別居時）', section: 'dependent', x: 58.5, y: 32.5, fontSize: 9, example: '', description: 'Ｂ欄2人目生計一（別居時のみ記載）' },
  ...
  { id: 'dep2EraMeiji', name: '扶養3元号 明（○印）', section: 'dependent', x: 38.6, y: 36.5, fontSize: 7, example: '○', description: 'Ｂ欄3人目 上段左「明」○印', isCircle: true },
  { id: 'dep2EraTaisho', name: '扶養3元号 大（○印）', section: 'dependent', x: 39.4, y: 36.5, fontSize: 7, example: '○', description: 'Ｂ欄3人目 上段右「大」○印', isCircle: true },
  { id: 'dep2EraShowa', name: '扶養3元号 昭（○印）', section: 'dependent', x: 38.6, y: 37.6, fontSize: 7, example: '○', description: 'Ｂ欄3人目 下段左「昭」○印', isCircle: true },
  { id: 'dep2EraHeisei', name: '扶養3元号 平（○印）', section: 'dependent', x: 39.4, y: 37.6, fontSize: 7, example: '○', description: 'Ｂ欄3人目 下段右「平」○印', isCircle: true },
  { id: 'dep2EraReiwa', name: '扶養3元号 令（○印）', section: 'dependent', x: 40.2, y: 37.6, fontSize: 7, example: '○', description: 'Ｂ欄3人目 「令」○印', isCircle: true },
  ...
  { id: 'dep2Living', name: '扶養3 同居別居（別居時）', section: 'dependent', x: 58.5, y: 37.5, fontSize: 9, example: '', description: 'Ｂ欄3人目生計一（別居時のみ記載）' },
  ...
  { id: 'dep3EraMeiji', name: '扶養4元号 明（○印）', section: 'dependent', x: 38.6, y: 41.5, fontSize: 7, example: '○', description: 'Ｂ欄4人目 上段左「明」○印', isCircle: true },
  { id: 'dep3EraTaisho', name: '扶養4元号 大（○印）', section: 'dependent', x: 39.4, y: 41.5, fontSize: 7, example: '○', description: 'Ｂ欄4人目 上段右「大」○印', isCircle: true },
  { id: 'dep3EraShowa', name: '扶養4元号 昭（○印）', section: 'dependent', x: 38.6, y: 42.6, fontSize: 7, example: '○', description: 'Ｂ欄4人目 下段左「昭」○印', isCircle: true },
  { id: 'dep3EraHeisei', name: '扶養4元号 平（○印）', section: 'dependent', x: 39.4, y: 42.6, fontSize: 7, example: '○', description: 'Ｂ欄4人目 下段右「平」○印', isCircle: true },
  { id: 'dep3EraReiwa', name: '扶養4元号 令（○印）', section: 'dependent', x: 40.2, y: 42.6, fontSize: 7, example: '○', description: 'Ｂ欄4人目 「令」○印', isCircle: true },
  ...
  { id: 'dep3Living', name: '扶養4 同居別居（別居時）', section: 'dependent', x: 58.5, y: 42.5, fontSize: 9, example: '', description: 'Ｂ欄4人目生計一（別居時のみ記載）' },
