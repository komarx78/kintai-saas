...
export type PublicDocType = 'employment_acquisition' | 'bonus_report' | 'tax_withholding';

export const OfficialDocMasterInspector: React.FC = () => {
  const [activeDoc, setActiveDoc] = useState<PublicDocType>('employment_acquisition'); // 取得届をデフォルト表示
      ...
      <div className="bg-slate-900 p-2 rounded-2xl border border-slate-800 flex flex-wrap items-center justify-between gap-2 shadow-lg">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          >
            ...
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-200 border border-emerald-500/30">
              NEW
            </span>
          </button>
