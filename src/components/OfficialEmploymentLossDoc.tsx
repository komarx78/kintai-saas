        ...
        <div className={`${isSidePanelOpen ? 'lg:col-span-8' : 'lg:col-span-12'} flex flex-col items-center overflow-x-auto print:block print:w-[210mm] print:p-0 print:m-0 print:overflow-visible pb-12 print:pb-0 transition-all duration-200`}>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl text-xs font-bold transition cursor-pointer flex items-center gap-1 border shadow-2xs ${
                  previewZoom <= 80 ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'
                }`}
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl text-xs font-bold transition cursor-pointer flex items-center gap-1 border shadow-2xs ${
                  previewZoom === 100 ? 'bg-indigo-50 border-indigo-300 text-indigo-700' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'
                }`}
          ...
          >
            <div 
              ...
              className="official-loss-print-container w-[210mm] h-[297mm] bg-white absolute top-0 left-0 shadow-xl border border-slate-300 text-slate-900 font-mono print:shadow-none print:border-none print:p-0 print:m-0 print:w-[210mm] print:h-[297mm] print:transform-none overflow-hidden select-none"
            >
